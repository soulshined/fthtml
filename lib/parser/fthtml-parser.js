...
class ftHTMLParser {
    ...
    parseMaybePragma() {
        ...
        if (_.isExpectedType(pragma.token, 'Pragma_vars'))
            ...
            this.throwIfEOF(new index_1.ftHTMLIncompleteElementError(pragma.token, 'a varibale, or alias, name'));
            if (!_.isExpectedType(this.peek(), "Word"))
                throw new index_1.ftHTMLInvalidTypeError(this.peek(), 'a varibale, or alias, name');
            const value = models_1.FTHTMLElement(this.consume());
