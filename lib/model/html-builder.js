...
class HTMLBuilder {
    ...
    static buildTag(element) {
        var _a, _b, _c;
        if (token_1.Token.Sequences.COMMENTS.includes(element.token.type))
            return '';
        ...
        else if (token_1.Token.isExpectedType(element.token, 'Pragma_if')) {
            return _c = element.parsedValue, (_c !== null && _c !== void 0 ? _c : '');
        }
        else if (element.parsedValue !== undefined && !token_1.Token.isExpectedType(element.token, 'Pragma_debug')) {
