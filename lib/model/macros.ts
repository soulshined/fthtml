...
const scripttag = (code: string) => `<script>document.write(${code});</script>`;
const rscripttag = (code: string) => `<script>(function() {
    ${code}
})();</script>`

export namespace FTHTMLMacros {
    ...
    export const ALL = {
        ...
        __UUID__: () => randomBytes(16).toString("hex"),
